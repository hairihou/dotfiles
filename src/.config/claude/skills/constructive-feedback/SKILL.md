...
description: Transform harsh, vague, or emotionally charged feedback text into actionable form using the Situation-Behavior-Impact-Suggestion framework. Use when the user has draft feedback to restructure or soften.
