...
Apply the strategy, key questions, and 1on1 approach for the assessed zone from the zone-specific strategies above.

### Step 4: Generate Agenda

Output a structured 1on1 agenda with the following sections:
...
- Member name (string, required via argument)
- Observation context (gathered interactively via AskUserQuestion in Step 1)
